...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "flexera-native:index:Random":
...
pulumi.runtime.registerResourceModule("flexera-native", "index", _module)
pulumi.runtime.registerResourcePackage("flexera-native", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:flexera-native") {
