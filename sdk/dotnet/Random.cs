...
{
    [FlexeraNativeResourceType("flexera-native:index:Random")]
    public partial class Random : global::Pulumi.CustomResource
    {
        ...
        public Random(string name, RandomArgs args, CustomResourceOptions? options = null)
            : base("flexera-native:index:Random", name, args ?? new RandomArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Random(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("flexera-native:index:Random", name, null, MakeResourceOptions(options, id))
        {
        }
